...
public class BondsViewActivity extends AppCompatActivity implements BondsViewAdapter.OnFriendListener{

    private static final String TAG = "BondsViewActivity";
    Student user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bonds_view);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                /*Intent intent = new Intent(BondsViewActivity.this, AccountActivity.class);
    ...
    private void setUpRecyclerView() {
        ...
        Query query = db.collection("Users/" + user.getDepno() + "/Bonds");
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        Intent intent = new Intent(BondsViewActivity.this,FriendAccountActivity.class);
                        intent.putExtra("user", user);
                        intent.putExtra("friend", s);
                        intent.putExtra("preAct", "BA");
                        startActivity(intent);
                    } else {
