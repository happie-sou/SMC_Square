...
public class FriendSplashesViewActivity extends AppCompatActivity implements SplashAdapter.OnSplashListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_friend_splashes_view);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                /*Intent intent = new Intent(FriendSplashesViewActivity.this, FriendAccountActivity.class);
                intent.putExtra("friend", friend);
                intent.putExtra("preAct", "FSA");
    ...
    private void loadPosts() {
        ...
        Query query = db.collection("Users/" + friend.getDepno() + "/Splashes");
        ...
        allSplash.setLayoutManager(new LinearLayoutManager(FriendSplashesViewActivity.this));

        splashAdapter.startListening();
        allSplash.setAdapter(splashAdapter);

        splashAdapter.setOnSplashListener(FriendSplashesViewActivity.this);
    }
    ...
    public void onCommentClick(int position, DocumentSnapshot snapshot) {
        Intent intent = new Intent(FriendSplashesViewActivity.this, CommentsActivity.class);
        intent.putExtra("user", user);
        intent.putExtra("postId",snapshot.getId());
        intent.putExtra("pName",snapshot.getString("depNo"));
        intent.putExtra("friend", friend);
        intent.putExtra("activity","FSA");
        startActivity(intent);
    }

    @Override
    public void onReactionCountClick(int position, DocumentSnapshot snapshot) {
        Intent intent = new Intent(FriendSplashesViewActivity.this, ReactionsViewActivity.class);
        intent.putExtra("user", user);
        intent.putExtra("postId",snapshot.getId());
        intent.putExtra("pName",snapshot.getString("depNo"));
        startActivity(intent);
